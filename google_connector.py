...
GOOGLE_GMAIL_DRAFT_SCOPES = [
    settings.google_gmail_compose_scope,
]
...
def _load_gmail_draft_credentials() -> Credentials:
    token_path = Path(settings.google_gmail_draft_token_path)
...
def build_gmail_draft_service() -> Any:
    credentials = _load_gmail_draft_credentials()
